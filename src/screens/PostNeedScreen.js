...
export default function PostNeedScreen({ navigation }) {
  ...
  const handlePostNeed = () => {
    ...
    Alert.alert(
      ...
      [{ text: 'OK', onPress: () => navigation.navigate('MyNeeds') }]
    );
  };
  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        {/* Post Button */}
        <TouchableOpacity style={styles.postButton} onPress={handlePostNeed}>
...
// NOTE: Add this line in the header section, after the profileButton
